...
public final class LauncherTraceFileProto extends
  ...
  // repeated .com.android.launcher3.tracing.LauncherTraceEntryProto entry = 2;
  public com.android.launcher3.tracing.nano.LauncherTraceEntryProto[] entry;
  ...
  public LauncherTraceFileProto clear() {
    magicNumber = 0L;
    entry = com.android.launcher3.tracing.nano.LauncherTraceEntryProto.emptyArray();
    cachedSize = -1;
    return this;
  }
  ...
  public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
    ...
    if (this.entry != null && this.entry.length > 0) {
      for (int i = 0; i < this.entry.length; i++) {
        com.android.launcher3.tracing.nano.LauncherTraceEntryProto element = this.entry[i];
        if (element != null) {
    ...
    while (true) {
      ...
      switch (tag) {
        ...
        case 18: {
          ...
          com.android.launcher3.tracing.nano.LauncherTraceEntryProto[] newArray =
              new com.android.launcher3.tracing.nano.LauncherTraceEntryProto[i + arrayLength];
          if (i != 0) {
            java.lang.System.arraycopy(this.entry, 0, newArray, 0, i);
          }
          for (; i < newArray.length - 1; i++) {
            newArray[i] = new com.android.launcher3.tracing.nano.LauncherTraceEntryProto();
