...
public interface LauncherLogProto {
  ...
  public static final class Target extends
    ...
    public Target clear() {
      ...
      searchQueryLength = 0;
      isWorkApp = false;
      fromFolderLabelState = com.android.launcher3.userevent.nano.LauncherLogProto.Target.FromFolderLabelState.FROM_FOLDER_LABEL_STATE_UNSPECIFIED;
      toFolderLabelState = com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_FOLDER_LABEL_STATE_UNSPECIFIED;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.fromFolderLabelState != com.android.launcher3.userevent.nano.LauncherLogProto.Target.FromFolderLabelState.FROM_FOLDER_LABEL_STATE_UNSPECIFIED) {
        output.writeInt32(20, this.fromFolderLabelState);
      }
      if (this.toFolderLabelState != com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_FOLDER_LABEL_STATE_UNSPECIFIED) {
        ...
        switch (tag) {
          ...
          case 48: {
            ...
            switch (value) {
              ...
              case com.android.launcher3.userevent.nano.LauncherLogProto.ContainerType.OTHER_LAUNCHER_APP:
          ...
          case 64: {
            ...
            switch (value) {
              ...
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.REMOTE_ACTION_SHORTCUT:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.APP_USAGE_SETTINGS:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.BACK_GESTURE:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.UNDO:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.DISMISS_PREDICTION:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.HYBRID_HOTSEAT_ACCEPTED:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.HYBRID_HOTSEAT_CANCELED:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.OVERVIEW_ACTIONS_SHARE_BUTTON:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.OVERVIEW_ACTIONS_SCREENSHOT_BUTTON:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.OVERVIEW_ACTIONS_SELECT_BUTTON:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.SELECT_MODE_CLOSE_BUTTON:
              case com.android.launcher3.userevent.nano.LauncherLogProto.ControlType.SELECT_MODE_ITEM:
          ...
          case 72: {
            ...
            switch (value) {
              ...
              case com.android.launcher3.userevent.nano.LauncherLogProto.ItemType.TASK_ICON:
                this.itemType = value;
                break;
            }
            break;
          ...
          case 136: {
            ...
            switch (value) {
              ...
              case com.android.launcher3.userevent.nano.LauncherLogProto.TipType.DWB_TOAST:
              case com.android.launcher3.userevent.nano.LauncherLogProto.TipType.HYBRID_HOTSEAT:
                this.tipType = value;
                break;
            }
            break;
          ...
          case 160: {
            int value = input.readInt32();
            switch (value) {
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.FromFolderLabelState.FROM_FOLDER_LABEL_STATE_UNSPECIFIED:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.FromFolderLabelState.FROM_EMPTY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.FromFolderLabelState.FROM_CUSTOM:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.FromFolderLabelState.FROM_SUGGESTED:
          ...
          case 168: {
            int value = input.readInt32();
            switch (value) {
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_FOLDER_LABEL_STATE_UNSPECIFIED:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_SUGGESTION0_WITH_VALID_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_SUGGESTION1_WITH_VALID_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_SUGGESTION1_WITH_EMPTY_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_SUGGESTION2_WITH_VALID_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_SUGGESTION2_WITH_EMPTY_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_SUGGESTION3_WITH_VALID_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_SUGGESTION3_WITH_EMPTY_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_EMPTY_WITH_VALID_SUGGESTIONS:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_EMPTY_WITH_VALID_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_EMPTY_WITH_VALID_SUGGESTIONS_AND_EMPTY_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_EMPTY_WITH_EMPTY_SUGGESTIONS:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_EMPTY_WITH_SUGGESTIONS_DISABLED:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_CUSTOM_WITH_VALID_SUGGESTIONS:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_CUSTOM_WITH_VALID_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_CUSTOM_WITH_VALID_SUGGESTIONS_AND_EMPTY_PRIMARY:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_CUSTOM_WITH_EMPTY_SUGGESTIONS:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.TO_CUSTOM_WITH_SUGGESTIONS_DISABLED:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Target.ToFolderLabelState.UNCHANGED:
        ...
        switch (tag) {
          ...
          case 8: {
            ...
            switch (value) {
              ...
              case com.android.launcher3.userevent.nano.LauncherLogProto.Action.Type.SOFT_KEYBOARD:
                this.type = value;
                break;
            }
            break;
          ...
          case 16: {
            ...
            switch (value) {
              ...
              case com.android.launcher3.userevent.nano.LauncherLogProto.Action.Touch.SWIPE_NOOP:
                this.touch = value;
                break;
            }
            break;
          ...
          case 24: {
            ...
            switch (value) {
              ...
              case com.android.launcher3.userevent.nano.LauncherLogProto.Action.Direction.UPRIGHT:
              case com.android.launcher3.userevent.nano.LauncherLogProto.Action.Direction.UPLEFT:
                this.dir = value;
                break;
            }
            break;
